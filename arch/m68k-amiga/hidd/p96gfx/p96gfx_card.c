...
static inline APTR __cardFunc(struct p96gfx_carddata *cid, WORD offset)
{
    APTR code = (APTR)((ULONG*)(((UBYTE*)(cid->boardinfo)) + offset))[0];
    D(bug("->RTG off=%d code=%p\n", (offset - (PSSO_BoardInfo_AllocCardMem)) / 4, code));
    pw (cid->boardinfo + PSSO_BoardInfo_AROSFlag, 1);
    return code;
}
...
BOOL FindCard(struct p96gfx_carddata *cid)
{
    if (cid->CardBase)
        return AROS_LVO_CALL1(BOOL,
            ...
            struct Library*, cid->CardBase, 5, );
    else
        return P96_LC1(BOOL, cid->p96romvector, 16,
            AROS_LCA(APTR, cid->boardinfo, A0));
}
...
BOOL InitCard(struct p96gfx_carddata *cid)
{
    if (cid->CardBase)
        return AROS_LVO_CALL2(BOOL,
            ...
            struct Library*, cid->CardBase, 6, );
   else
        return P96_LC2(BOOL, cid->p96romvector, 29,
            AROS_LCA(APTR, cid->boardinfo, A0),       // For current WinP96s
            AROS_LCA(APTR, cid->boardinfo, A2));      // For older E-P96s
}

void WaitBlitter(struct p96gfx_carddata *cid)
{
    if (cid->CardBase)
        AROS_CALL1NR(void, __cardFunc(cid, PSSO_BoardInfo_WaitBlitter),
            AROS_LCA(APTR, cid->boardinfo, A0),
...
{
    if (cid->CardBase)
        AROS_CALL2(ULONG, __cardFunc(cid, PSSO_BoardInfo_SetInterrupt),
            AROS_LCA(APTR, cid->boardinfo, A0),
...
{
    if (cid->CardBase)
        return AROS_CALL4(ULONG, __cardFunc(cid, PSSO_BoardInfo_GetPixelClock),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, mi, A1),
...
{
    if (cid->CardBase)
        AROS_CALL2(ULONG, __cardFunc(cid, PSSO_BoardInfo_SetMemoryMode),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(ULONG, rgbformat, D7),
            struct Library*, cid->CardBase);
}
...
{
    if (cid->CardBase)
        return AROS_CALL4(ULONG, __cardFunc(cid, PSSO_BoardInfo_ResolvePixelClock),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, mi, A1),
...
{
    if (cid->CardBase)
        return AROS_CALL1(ULONG, __cardFunc(cid, PSSO_BoardInfo_SetClock),
            AROS_LCA(APTR, cid->boardinfo, A0),
            struct Library*, cid->CardBase);
    else
        return -2;
...
{
    if (cid->CardBase)
        return AROS_CALL2(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetDisplay),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(BOOL, state, D0),
            struct Library*, cid->CardBase);
    else
        return P96_LC2(BOOL, cid->p96romvector, 26,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(BOOL, state, D0));
}
...
{
    if (cid->CardBase)
        return AROS_CALL2(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetSwitch),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(BOOL, state, D0),
            struct Library*, cid->CardBase);
    else
        return P96_LC2(BOOL, cid->p96romvector, 18,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(BOOL, state, D0));
}
...
{
    if (cid->CardBase)
        AROS_CALL3(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetColorArray),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(WORD, start, D0),
            AROS_LCA(WORD, count, D1),
            struct Library*, cid->CardBase);
    else
        P96_LC3(BOOL, cid->p96romvector, 19,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(WORD, start, D0),
            AROS_LCA(WORD, count, D1));
}
...
{
    if (cid->CardBase)
        AROS_CALL2(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetDAC),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(ULONG, *cid->rgbformat, D7),
            struct Library*, cid->CardBase);
    else
        P96_LC2(BOOL, cid->p96romvector, 20,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(ULONG, *cid->rgbformat, D7));
}
...
{
    if (cid->CardBase)
        AROS_CALL3(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetGC),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, mi, A1),
            AROS_LCA(BOOL, border, D0),
            struct Library*, cid->CardBase);
    else
        P96_LC3(BOOL, cid->p96romvector, 21,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, mi, A1),
            AROS_LCA(BOOL, border, D0));
}
...
{
    if (cid->CardBase)
        AROS_CALL6(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetPanning),
            AROS_LCA(APTR, cid->boardinfo, A0),
        ...
        P96_LC6(BOOL, cid->p96romvector, 22,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, video, A1),
            AROS_LCA(UWORD, width, D0),
            AROS_LCA(WORD, x, D1),
...
{
    if (cid->CardBase) {
        AROS_CALL10(BOOL, __cardFunc(cid, PSSO_BoardInfo_BlitRect),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(WORD, sx, D0),
            AROS_LCA(WORD, sy, D1),
        ...
        return P96_LC10(BOOL, cid->p96romvector, 28,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(WORD, sx, D0),
            AROS_LCA(WORD, sy, D1),
...
{
    if (cid->CardBase) {
        AROS_CALL9(BOOL, __cardFunc(cid, PSSO_BoardInfo_FillRect),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(WORD, x, D0),
            AROS_LCA(WORD, y, D1),
        ...
        return P96_LC9(BOOL, cid->p96romvector, 17,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(WORD, x, D0),
            AROS_LCA(WORD, y, D1),
...
{
    if (cid->CardBase) {
        AROS_CALL8(BOOL, __cardFunc(cid, PSSO_BoardInfo_InvertRect),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(WORD, x, D0),
            AROS_LCA(WORD, y, D1),
        ...
        return P96_LC8(BOOL, cid->p96romvector, 31,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(WORD, x, D0),
            AROS_LCA(WORD, y, D1),
...
{
    if (cid->CardBase) {
        AROS_CALL11(BOOL, __cardFunc(cid, PSSO_BoardInfo_BlitRectNoMaskComplete),
            AROS_LCA(APTR, cid->boardinfo, A0),
        ...
        return P96_LC11(BOOL, cid->p96romvector, 28,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, risrc, A1),
            AROS_LCA(APTR, ridst, A2),
            AROS_LCA(WORD, sx, D0),
...
{
    if (cid->CardBase) {
        AROS_CALL9(BOOL, __cardFunc(cid, PSSO_BoardInfo_BlitPattern),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
        ...
        return P96_LC9(BOOL, cid->p96romvector, 30,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(APTR, pat, A2),
            AROS_LCA(WORD, x, D0),
...
{
    if (cid->CardBase) {
        AROS_CALL9(BOOL, __cardFunc(cid, PSSO_BoardInfo_BlitTemplate),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
        ...
        return P96_LC9(BOOL, cid->p96romvector, 27,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(APTR, ri, A1),
            AROS_LCA(APTR, tmpl, A2),
            AROS_LCA(WORD, x, D0),
...
{
    if (cid->CardBase)
        return AROS_CALL3(BOOL, __cardFunc(cid, PSSO_BoardInfo_CalculateBytesPerRow),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(UWORD, width, D0),
            AROS_LCA(ULONG, rgbformat, D7),
            struct Library*, cid->CardBase);
    else
        return P96_LC3(BOOL, cid->p96romvector, 23,
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(UWORD, width, D0),
            AROS_LCA(ULONG, rgbformat, D7));
}
...
{
    if (cid->CardBase)
        return AROS_CALL3(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetSprite),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(BOOL, activate, D0),
            AROS_LCA(ULONG, *cid->rgbformat, D7),
            struct Library*, cid->CardBase);
    return P96_LC3(BOOL, cid->p96romvector, 36,
        AROS_LCA(APTR, cid->boardinfo, A0),
        AROS_LCA(BOOL, activate, D0),
        AROS_LCA(ULONG, *cid->rgbformat, D7));
}
...
{
    if (cid->CardBase)
        return AROS_CALL2(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetSpriteImage),
            AROS_LCA(APTR, cid->boardinfo, A0),
            AROS_LCA(ULONG, *cid->rgbformat, D7),
            struct Library*, cid->CardBase);
    return P96_LC2(BOOL, cid->p96romvector, 38,
        AROS_LCA(APTR, cid->boardinfo, A0),
        AROS_LCA(ULONG, *cid->rgbformat, D7));
}
...
{
    if (cid->CardBase)
        return AROS_CALL6(BOOL, __cardFunc(cid, PSSO_BoardInfo_SetSpriteColor),
            AROS_LCA(APTR, cid->boardinfo, A0),
            ...
            AROS_LCA(ULONG, *cid->rgbformat, D7),
            struct Library*, cid->CardBase);
    return P96_LC6(BOOL, cid->p96romvector, 39,
        AROS_LCA(APTR, cid->boardinfo, A0),
        AROS_LCA(UBYTE, idx, D0),
        AROS_LCA(UBYTE, r, D1),
        AROS_LCA(UBYTE, g, D2),
