...
/****i* realtek8180.device/ServiceRequest **********************************
*
*   NAME
...
/****i* realtek8180.device/CMD_INVALID *************************************
*
*   NAME
...
/****** realtek8180.device/S2_MULTICAST ************************************
*
*   NAME
*	S2_MULTICAST
*
...
/****** realtek8180.device/S2_DEVICEQUERY **********************************
*
*   NAME
...
/****** realtek8180.device/S2_GETSTATIONADDDRESS ***************************
*
*   NAME
...
/****** realtek8180.device/S2_CONFIGINTERFACE ******************************
*
*   NAME
*	S2_CONFIGINTERFACE
*
...
/****** realtek8180.device/S2_BROADCAST ************************************
*
*   NAME
*	S2_BROADCAST
*
...
/****** realtek8180.device/S2_TRACKTYPE ************************************
*
*   NAME
*	S2_TRACKTYPE
*
...
/****** realtek8180.device/S2_UNTRACKTYPE **********************************
*
*   NAME
*	S2_UNTRACKTYPE
*
...
/****** realtek8180.device/S2_GETTYPESTATS *********************************
*
*   NAME
*	S2_GETTYPESTATS
*
...
/****** realtek8180.device/S2_GETSPECIALSTATS ******************************
*
*   NAME
*	S2_GETSPECIALSTATS
*
...
/****** realtek8180.device/S2_GETGLOBALSTATS *******************************
*
*   NAME
*	S2_GETGLOBALSTATS
*
...
/****** realtek8180.device/S2_READORPHAN ***********************************
*
*   NAME
*	S2_READORPHAN
*
...
/****** realtek8180.device/NSCMD_DEVICEQUERY *******************************
*
*   NAME
...
/****** realtek8180.device/S2_ADDMULTICASTADDRESS **************************
*
*   NAME
*	S2_ADDMULTICASTADDRESS
*
...
/****** realtek8180.device/S2_ADDMULTICASTADDRESSES ************************
*
*   NAME
*	S2_ADDMULTICASTADDRESSES
*
...
/****** realtek8180.device/S2_DELMULTICASTADDRESS **************************
*
*   NAME
*	S2_DELMULTICASTADDRESS
*
...
/****** realtek8180.device/S2_DELMULTICASTADDRESSES ************************
*
*   NAME
*	S2_DELMULTICASTADDRESSES
*
...
/****** realtek8180.device/S2_SETOPTIONS ***********************************
*
*   NAME
...
/****** realtek8180.device/S2_WRITEMGMT ************************************
*
*   NAME
...
/****** realtek8180.device/S2_READMGMT *************************************
*
*   NAME
...
/****i* realtek8180.device/PutRequest **************************************
*
*   NAME
*	PutRequest
*
