...
/****i* broadcom4400.device/ServiceRequest *********************************
*
*   NAME
...
/****i* broadcom4400.device/CMD_INVALID ************************************
*
*   NAME
...
/****** broadcom4400.device/S2_MULTICAST ***********************************
*
*   NAME
*	S2_MULTICAST
*
...
/****** broadcom4400.device/S2_DEVICEQUERY *********************************
*
*   NAME
...
/****** broadcom4400.device/S2_GETSTATIONADDDRESS **************************
*
*   NAME
...
/****** broadcom4400.device/S2_CONFIGINTERFACE *****************************
*
*   NAME
*	S2_CONFIGINTERFACE
*
...
/****** broadcom4400.device/S2_BROADCAST ***********************************
*
*   NAME
*	S2_BROADCAST
*
...
/****** broadcom4400.device/S2_TRACKTYPE ***********************************
*
*   NAME
*	S2_TRACKTYPE
*
...
*
*   INPUTS
*	ios2_PacketType - frame type to start tracking.
*
*   RESULTS
*	io_Error
*	ios2_WireError
   ...
   struct DevBase *base)
{
   struct DevUnit *unit;
   struct Opener *opener;
   ULONG frame_type, wire_error;
   struct TypeTracker *tracker;
   struct TypeStats *initial_stats;
   BYTE error = 0;

   unit = (APTR)request->ios2_Req.io_Unit;
   frame_type = request->ios2_PacketType;
   ...
   opener = request->ios2_BufferManagement;
   initial_stats = FindTypeStats(unit, &opener->initial_stats, frame_type,
      base);
...
/****** broadcom4400.device/S2_UNTRACKTYPE *********************************
*
*   NAME
*	S2_UNTRACKTYPE
*
...
*
*   INPUTS
*	ios2_PacketType - frame type to stop tracking.
*
*   RESULTS
*	io_Error
*	ios2_WireError
...
/****** broadcom4400.device/S2_GETTYPESTATS ********************************
*
*   NAME
*	S2_GETTYPESTATS
*
...
*
*   INPUTS
*	ios2_PacketType - frame type to get statistics on.
   ...
   struct DevBase *base)
{
   ...
   tracker = FindTypeStats(unit, &unit->type_trackers, frame_type, base);
   opener = request->ios2_BufferManagement;
   initial_stats = FindTypeStats(unit, &opener->initial_stats, frame_type,
      base);
...
/****** broadcom4400.device/S2_GETSPECIALSTATS *****************************
*
*   NAME
*	S2_GETSPECIALSTATS
*
...
/****** broadcom4400.device/S2_GETGLOBALSTATS ******************************
*
*   NAME
*	S2_GETGLOBALSTATS
*
...
/****** broadcom4400.device/S2_ONEVENT *************************************
*
*   NAME
*	S2_ONEVENT
*
...
/****** broadcom4400.device/S2_READORPHAN **********************************
*
*   NAME
*	S2_READORPHAN
*
...
*	io_Error
*	ios2_WireError
*	ios2_PacketType - A copy of the frame's type field.
*	ios2_SrcAddr
*	ios2_DstAddr
*	ios2_DataLength
*	ios2_Data
...
/****** broadcom4400.device/S2_OFFLINE *************************************
*
*   NAME
*	S2_OFFLINE
*
...
/****** broadcom4400.device/NSCMD_DEVICEQUERY ******************************
*
*   NAME
...
/****** broadcom4400.device/S2_ADDMULTICASTADDRESS *************************
*
*   NAME
*	S2_ADDMULTICASTADDRESS
*
...
/****** broadcom4400.device/S2_ADDMULTICASTADDRESSES ***********************
*
*   NAME
*	S2_ADDMULTICASTADDRESSES
*
...
/****** broadcom4400.device/S2_DELMULTICASTADDRESS *************************
*
*   NAME
*	S2_DELMULTICASTADDRESS
*
...
/****** broadcom4400.device/S2_DELMULTICASTADDRESSES ***********************
*
*   NAME
*	S2_DELMULTICASTADDRESSES
*
...
/****i* broadcom4400.device/PutRequest *************************************
*
*   NAME
*	PutRequest
*
