...
static BOOL CmdWriteMgmt(struct IOSana2Req *request, struct DevBase *base);
static BOOL CmdReadMgmt(struct IOSana2Req *request, struct DevBase *base);
...
/****i* atheros5000.device/ServiceRequest **********************************
*
*   NAME
...
VOID ServiceRequest(struct IOSana2Req *request, struct DevBase *base)
{
   ...
   case S2_SETKEY:
      ...
      break;
   case S2_WRITEMGMT:
      complete = CmdWriteMgmt(request, base);
      break;
   case S2_READMGMT:
      complete = CmdReadMgmt(request, base);
      break;
   default:
...
/****i* atheros5000.device/CMD_INVALID *************************************
*
*   NAME
...
/****** atheros5000.device/S2_MULTICAST ************************************
*
*   NAME
*	S2_MULTICAST
*
...
/****** atheros5000.device/S2_DEVICEQUERY **********************************
*
*   NAME
...
/****** atheros5000.device/S2_GETSTATIONADDDRESS ***************************
*
*   NAME
...
/****** atheros5000.device/S2_CONFIGINTERFACE ******************************
*
*   NAME
*	S2_CONFIGINTERFACE
*
...
/****** atheros5000.device/S2_BROADCAST ************************************
*
*   NAME
*	S2_BROADCAST
*
...
/****** atheros5000.device/S2_TRACKTYPE ************************************
*
*   NAME
*	S2_TRACKTYPE
*
...
/****** atheros5000.device/S2_UNTRACKTYPE **********************************
*
*   NAME
*	S2_UNTRACKTYPE
*
...
/****** atheros5000.device/S2_GETTYPESTATS *********************************
*
*   NAME
*	S2_GETTYPESTATS
*
...
/****** atheros5000.device/S2_GETSPECIALSTATS ******************************
*
*   NAME
*	S2_GETSPECIALSTATS
*
...
/****** atheros5000.device/S2_GETGLOBALSTATS *******************************
*
*   NAME
*	S2_GETGLOBALSTATS
*
...
/****** atheros5000.device/S2_READORPHAN ***********************************
*
*   NAME
*	S2_READORPHAN
*
...
/****** atheros5000.device/NSCMD_DEVICEQUERY *******************************
*
*   NAME
...
/****** atheros5000.device/S2_ADDMULTICASTADDRESS **************************
*
*   NAME
*	S2_ADDMULTICASTADDRESS
*
...
/****** atheros5000.device/S2_ADDMULTICASTADDRESSES ************************
*
*   NAME
*	S2_ADDMULTICASTADDRESSES
*
...
/****** atheros5000.device/S2_DELMULTICASTADDRESS **************************
*
*   NAME
*	S2_DELMULTICASTADDRESS
*
...
/****** atheros5000.device/S2_DELMULTICASTADDRESSES ************************
*
*   NAME
*	S2_DELMULTICASTADDRESSES
*
...
/****** atheros5000.device/S2_SETOPTIONS ***********************************
*
*   NAME
...
static BOOL CmdSetOptions(struct IOSana2Req *request, struct DevBase *base)
{
   ...
   if(reconfigure && (unit->flags & UNITF_ONLINE) != 0)
      ConfigureAdapter(unit, base);
...
/****** atheros5000.device/S2_WRITEMGMT ************************************
*
*   NAME
...
static BOOL CmdWriteMgmt(struct IOSana2Req *request, struct DevBase *base)
{
   ...
   if(error == 0)
      PutRequest(unit->request_ports[MGMT_QUEUE], (APTR)request, base);
   else
   {
      request->ios2_Req.io_Error = error;
      request->ios2_WireError = wire_error;
...
/****** atheros5000.device/S2_READMGMT *************************************
*
*   NAME
...
static BOOL CmdReadMgmt(struct IOSana2Req *request, struct DevBase *base)
{
   ...
   {
      opener = request->ios2_BufferManagement;
      PutRequest(&opener->mgmt_port, (APTR)request, base);
   }
   else
   {
      request->ios2_Req.io_Error = S2ERR_OUTOFSERVICE;
...
/****i* atheros5000.device/PutRequest **************************************
*
*   NAME
*	PutRequest
*
