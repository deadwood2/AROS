...
PACKAGE_VERSION_SOURCE=20180423-1
PACKAGE_VERSION_SOURCE_CONTRIB=20180423-1
...
# PC ISO
if [[ -f $ROOT/alt-abiv0-pc-i386/distfiles/aros-pc-i386.iso ]]
then
makedir $PACKAGE_PC
...
# Linux System
if [[ -d $ROOT/alt-abiv0-linux-i386/bin/linux-i386/AROS ]]
then
...
# Mingw32 System
if [[ -d $ROOT/alt-abiv0-mingw32-i386/bin/mingw32-i386/AROS ]]
then
...
# Contrib
if [[ -d $ROOT/alt-abiv0-contrib-i386/bin/linux-i386/AROS ]]
then
