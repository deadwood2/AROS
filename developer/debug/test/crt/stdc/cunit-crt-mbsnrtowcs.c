...
static void test_mbsnrtowcs_1(void) {
    ...
    converted = mbsnrtowcs(wcs, &string, strlen(string)+1, sizeof(wcs), NULL);
...
int main(int argc, char** argv) {
    //Define test suite
    CU_CI_DEFINE_SUITE(mbsnrtowcs_Suite, NULL, NULL, NULL, NULL);
    CUNIT_CI_TEST(test_mbsnrtowcs_1);
