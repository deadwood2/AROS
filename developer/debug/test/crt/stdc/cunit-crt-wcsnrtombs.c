...
static void test_wcsnrtombs_1(void) {
    ...
    converted = wcsnrtombs(multibyte_str, &wide_str, 50, sizeof(multibyte_str) - 1, NULL);
...
static void test_wcsnrtombs_2(void) {
    // Test with a null pointer for the wide string
    size_t converted;
    converted = wcsnrtombs(NULL, NULL, 0, 0, NULL);
 ...
 int main(int argc, char** argv) {
    //Define test suite
    CU_CI_DEFINE_SUITE("wcsnrtombs_Suite", NULL, NULL, NULL, NULL);
    CUNIT_CI_TEST(test_wcsnrtombs_1);
    CUNIT_CI_TEST(test_wcsnrtombs_2);
